...
def Generate_Operational_Activity_Report(oa):
    templ = """
    <h2 style= "padding-left: 0"style= "padding-left: 0"> {{ oa.name }} - <span style="font-size: 10px" > UUID: {{ oa.uuid }} </span> </h1>
    {% if oa.summary %}
...
def Generate_Physical_Node_Component_Report( node ):
    templ = """
